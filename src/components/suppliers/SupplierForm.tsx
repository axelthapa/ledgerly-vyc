...
import { Supplier } from '@/utils/supplier-utils';
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4 py-2">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Number of days you have to pay this supplier (0 for cash only)
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="flex justify-end space-x-4 pt-2">
          ...
          <Button type="submit" disabled={isLoading}>
            {isLoading ? 'Saving...' : defaultValues?.id ? 'Update Supplier' : 'Add Supplier'}
          </Button>
        </div>
      </form>
    </Form>
